...
var Emoji = {
	txt: ['😄 ','😃 ','😀 ','😊 ','☺️ ','😉 ','😍 ','😘 ','😚 ','😗 ','😙 ','😜 ','😝 ','😛 ','😳 ','😁 ','😔 ','😌 ','😒 ','😞 ','😣 ','😢 ','😂 ','😭 ','😪 ','😥 ','😰 ','😅 ','😓 ','😩 ','😫 ','😨 ','😱 ','😠 ','😡 ','😤 ','😖 ','😆 ','😋 ','😷 ','😎 ','😴 ','😵 ','😲 ','😟 ','😦 ','😧 ','😈 ','👿 ','😮 ','😬 ','😐 ','😕 ','😯 ','😶 ','😇 ','😏 ','😑 ','👲 ','👳 ','👮 ','👷 ','💂 ','👶 ','👦 ','👧 ','👨 ','👩 ','👴 ','👵 ','👱 ','👼 ','👸 ','😺 ','😸 ','😻 ','😽 ','😼 ','🙀 ','😿 ','😹 ','😾 ','👹 ','👺 ','🙈 ','🙉 ','🙊 ','💀 ','👽 ','💩 ','🔥 ','✨ ','🌟 ','💫 ','💥 ','💢 ','💦 ','💧 ','💤 ','💨 ','👂 ','👀 ','👃 ','👅 ','👄 ','👍 ','👎 ','👌 ','👊 ','✊ ','✌️ ','👋 ','✋ ','👐 ','👆 ','👇 ','👉 ','👈 ','🙌 ','🙏 ','☝️ ','👏 ','💪 ','🚶 ','🏃 ','💃 ','👫 ','👪 ','👬 ','👭 ','💏 ','💑 ','👯 ','🙆 ','🙅 ','💁 ','🙋 ','💆 ','💇 ','💅 ','👰 ','🙎 ','🙍 ','🙇 ','🎩 ','👑 ','👒 ','👟 ','👞 ','👡 ','👠 ','👢 ','👕 ','👔 ','👚 ','👗 ','🎽 ','👖 ','👘 ','👙 ','💼 ','👜 ','👝 ','👛 ','👓 ','🎀 ','🌂 ','💄 ','💛 ','💙 ','💜 ','💚 ','❤️ ','💔 ','💗 ','💓 ','💕 ','💖 ','💞 ','💘 ','💌 ','💋 ','💍 ','💎 ','👤 ','👥 ','💬 ','👣 ','💭 ','🐶 ','🐺 ','🐱 ','🐭 ','🐹 ','🐰 ','🐸 ','🐯 ','🐨 ','🐻 ','🐷 ','🐽 ','🐮 ','🐗 ','🐵 ','🐒 ','🐴 ','🐑 ','🐘 ','🐼 ','🐧 ','🐦 ','🐤 ','🐥 ','🐣 ','🐔 ','🐍 ','🐢 ','🐛 ','🐝 ','🐜 ','🐞 ','🐌 ','🐙 ','🐚 ','🐠 ','🐟 ','🐬 ','🐳 ','🐋 ','🐄 ','🐏 ','🐀 ','🐃 ','🐅 ','🐇 ','🐉 ','🐎 ','🐐 ','🐓 ','🐕 ','🐖 ','🐁 ','🐂 ','🐲 ','🐡 ','🐊 ','🐫 ','🐪 ','🐆 ','🐈 ','🐩 ','🐾 ','💐 ','🌸 ','🌷 ','🍀 ','🌹 ','🌻 ','🌺 ','🍁 ','🍃 ','🍂 ','🌿 ','🌾 ','🍄 ','🌵 ','🌴 ','🌲 ','🌳 ','🌰 ','🌱 ','🌼 ','🌐 ','🌞 ','🌝 ','🌚 ','🌑 ','🌒 ','🌓 ','🌔 ','🌕 ','🌖 ','🌗 ','🌘 ','🌜 ','🌛 ','🌙 ','🌍 ','🌎 ','🌏 ','🌋 ','🌌 ','🌠 ','⭐️ ','☀️ ','⛅️ ','☁️ ','⚡️ ','☔️ ','❄️ ','⛄️ ','🌀 ','🌁 ','🌈 ','🌊 ','🎍 ','💝 ','🎎 ','🎒 ','🎓 ','🎏 ','🎆 ','🎇 ','🎐 ','🎑 ','🎃 ','👻 ','🎅 ','🎄 ','🎁 ','🎋 ','🎉 ','🎊 ','🎈 ','🎌 ','🔮 ','🎥 ','📷 ','📹 ','📼 ','💿 ','📀 ','💽 ','💾 ','💻 ','📱 ','☎️ ','📞 ','📟 ','📠 ','📡 ','📺 ','📻 ','🔊 ','🔉 ','🔈 ','🔇 ','🔔 ','🔕 ','📢 ','📣 ','⏳ ','⌛️ ','⏰ ','⌚️ ','🔓 ','🔒 ','🔏 ','🔐 ','🔑 ','🔎 ','💡 ','🔦 ','🔆 ','🔅 ','🔌 ','🔋 ','🔍 ','🛁 ','🛀 ','🚿 ','🚽 ','🔧 ','🔩 ','🔨 ','🚪 ','🚬 ','💣 ','🔫 ','🔪 ','💊 ','💉 ','💰 ','💴 ','💵 ','💷 ','💶 ','💳 ','💸 ','📲 ','📧 ','📥 ','📤 ','✉️ ','📩 ','📨 ','📯 ','📫 ','📪 ','📬 ','📭 ','📮 ','📦 ','📝 ','📄 ','📃 ','📑 ','📊 ','📈 ','📉 ','📜 ','📋 ','📅 ','📆 ','📇 ','📁 ','📂 ','✂️ ','📌 ','📎 ','✒️ ','✏️ ','📏 ','📐 ','📕 ','📗 ','📘 ','📙 ','📓 ','📔 ','📒 ','📚 ','📖 ','🔖 ','📛 ','🔬 ','🔭 ','📰 ','🎨 ','🎬 ','🎤 ','🎧 ','🎼 ','🎵 ','🎶 ','🎹 ','🎻 ','🎺 ','🎷 ','🎸 ','👾 ','🎮 ','🃏 ','🎴 ','🀄️ ','🎲 ','🎯 ','🏈 ','🏀 ','⚽️ ','⚾️ ','🎾 ','🎱 ','🏉 ','🎳 ','⛳️ ','🚵 ','🚴 ','🏁 ','🏇 ','🏆 ','🎿 ','🏂 ','🏊 ','🏄 ','🎣 ','☕️ ','🍵 ','🍶 ','🍼 ','🍺 ','🍻 ','🍸 ','🍹 ','🍷 ','🍴 ','🍕 ','🍔 ','🍟 ','🍗 ','🍖 ','🍝 ','🍛 ','🍤 ','🍱 ','🍣 ','🍥 ','🍙 ','🍘 ','🍚 ','🍜 ','🍲 ','🍢 ','🍡 ','🍳 ','🍞 ','🍩 ','🍮 ','🍦 ','🍨 ','🍧 ','🎂 ','🍰 ','🍪 ','🍫 ','🍬 ','🍭 ','🍯 ','🍎 ','🍏 ','🍊 ','🍋 ','🍒 ','🍇 ','🍉 ','🍓 ','🍑 ','🍈 ','🍌 ','🍐 ','🍍 ','🍠 ','🍆 ','🍅 ','🌽 ','🏠 ','🏡 ','🏫 ','🏢 ','🏣 ','🏥 ','🏦 ','🏪 ','🏩 ','🏨 ','💒 ','⛪️ ','🏬 ','🏤 ','🌇 ','🌆 ','🏯 ','🏰 ','⛺️ ','🏭 ','🗼 ','🗾 ','🗻 ','🌄 ','🌅 ','🌃 ','🗽 ','🌉 ','🎠 ','🎡 ','⛲️ ','🎢 ','🚢 ','⛵️ ','🚤 ','🚣 ','⚓️ ','🚀 ','✈️ ','💺 ','🚁 ','🚂 ','🚊 ','🚉 ','🚞 ','🚆 ','🚄 ','🚅 ','🚈 ','🚇 ','🚝 ','🚋 ','🚃 ','🚎 ','🚌 ','🚍 ','🚙 ','🚘 ','🚗 ','🚕 ','🚖 ','🚛 ','🚚 ','🚨 ','🚓 ','🚔 ','🚒 ','🚑 ','🚐 ','🚲 ','🚡 ','🚟 ','🚠 ','🚜 ','💈 ','🚏 ','🎫 ','🚦 ','🚥 ','⚠️ ','🚧 ','🔰 ','⛽️ ','🏮 ','🎰 ','♨️ ','🗿 ','🎪 ','🎭 ','📍 ','🚩 ','🇯🇵 ','🇰🇷 ','🇩🇪 ','🇨🇳 ','🇺🇸 ','🇫🇷 ','🇪🇸 ','🇮🇹 ','🇷🇺 ','🇬🇧 ','1️⃣ ','2️⃣ ','3️⃣ ','4️⃣ ','5️⃣ ','6️⃣ ','7️⃣ ','8️⃣ ','9️⃣ ','0️⃣ ','🔟 ','🔢 ','#️⃣ ','🔣 ','⬆️ ','⬇️ ','⬅️ ','➡️ ','🔠 ','🔡 ','🔤 ','↗️ ','↖️ ','↘️ ','↙️ ','↔️ ','↕️ ','🔄 ','◀️ ','▶️ ','🔼 ','🔽 ','↩️ ','↪️ ','ℹ️ ','⏪ ','⏩ ','⏫ ','⏬ ','⤵️ ','⤴️ ','🆗 ','🔀 ','🔁 ','🔂 ','🆕 ','🆙 ','🆒 ','🆓 ','🆖 ','📶 ','🎦 ','🈁 ','🈯️ ','🈳 ','🈵 ','🈴 ','🈲 ','🉐 ','🈹 ','🈺 ','🈶 ','🈚️ ','🚻 ','🚹 ','🚺 ','🚼 ','🚾 ','🚰 ','🚮 ','🅿️ ','♿️ ','🚭 ','🈷 ','🈸 ','🈂 ','Ⓜ️ ','🛂 ','🛄 ','🛅 ','🛃 ','🉑 ','㊙️ ','㊗️ ','🆑 ','🆘 ','🆔 ','🚫 ','🔞 ','📵 ','🚯 ','🚱 ','🚳 ','🚷 ','🚸 ','⛔️ ','✳️ ','❇️ ','❎ ','✅ ','✴️ ','💟 ','🆚 ','📳 ','📴 ','🅰 ','🅱 ','🆎 ','🅾 ','💠 ','➿ ','♻️ ','♈️ ','♉️ ','♊️ ','♋️ ','♌️ ','♍️ ','♎️ ','♏️ ','♐️ ','♑️ ','♒️ ','♓️ ','⛎ ','🔯 ','🏧 ','💹 ','💲 ','💱 ','© ','® ','™ ','❌ ','‼️ ','⁉️ ','❗️ ','❓ ','❕ ','❔ ','⭕️ ','🔝 ','🔚 ','🔙 ','🔛 ','🔜 ','🔃 ','🕛 ','🕧 ','🕐 ','🕜 ','🕑 ','🕝 ','🕒 ','🕞 ','🕓 ','🕟 ','🕔 ','🕠 ','🕕 ','🕖 ','🕗 ','🕘 ','🕙 ','🕚 ','🕡 ','🕢 ','🕣 ','🕤 ','🕥 ','🕦 ','✖️ ','➕ ','➖ ','➗ ','♠️ ','♥️ ','♣️ ','♦️ ','💮 ','💯 ','✔️ ','☑️ ','🔘 ','🔗 ','➰ ','〰 ','〽️ ','🔱 ','◼️ ','◻️ ','◾️ ','◽️ ','▪️ ','▫️ ','🔺 ','🔲 ','🔳 ','⚫️ ','⚪️ ','🔴 ','🔵 ','🔻 ','⬜️ ','⬛️ ','🔶 ','🔷 ','🔸 ','🔹 '],
	...
	emojiPath: 'http://static.91fool.com.cn/public/emoji2/emoji/',

	//表情图片的最大尺寸
	maxSize: 20,

	emoji_to_text: function(text){
		text = text.replace(/\[em_(\d*)\]/g, function(code) {
			var code = code.replace("[em_", "");
			code = code.replace("]", "");
			return Emoji.txt[parseInt(code)];
		});
		return text;
	},
...
emoji_to_text = function(text) {
	return Emoji.emoji_to_text(text);
};